!(function (e, t) {
  ...
  function u(e, t = !1, n = !1) {
    let r,
      ...
      s = [];
    for (; (r = a.nextNode()); )
      r.originalParent || (r.originalParent = r.parentNode), s.push(r);
    ...
    let S = async (e, t, n = !1) => {
      ...
      M = (e = 0) =>
        (function (e) {
          ...
          return (
            (n = null !== n ? n : t / 3), r ? [y(t, p(t)), y(n, p(n))] : [t, n]
          );
        })(G)[e],
      x = () =>
        ((e) =>
          m(e)
            ? n(e.value)
            : u(e, !0).filter((e) => !(e.childNodes.length > 0)))(V),
      A = (e, t) => (
        Y.add(e),
        ((e = {}) => {
          let t = e.delay;
      ...
      k = async () => {
        if ((!I() && ee && V.appendChild(ee), Z)) {
          ...
          L({
            frames: t,
            cursor: ee,
            options: { duration: G.cursorSpeed, ...n },
          });
        }
      },
      $ = async (e = !0) => {
        ...
        let n = O(t),
          ...
          s =
            null === r
              ...
              : b(r)
              ? r
              : P({ queueItems: o, selector: r, cursorPosition: H(), to: a });
        return A(
          [
            n[0],
            ...E({ func: j, delay: i ? 0 : M(1), deletable: !0 }, s),
            n[1],
          ],
          t
        );
        ...
        return (
          ...
          A(
            [
              n[0],
              ...E(
                { func: () => q(o), delay: r ? 0 : M(), cursorable: !0 },
                Math.abs(a)
              ),
              n[1],
            ],
    ...
    let Z = !!G.cursor && !I(),
      ee = (() => {
        ...
        return (
          (e.className = o),
          Z
            ? ((e.innerHTML = a(G.cursorChar).innerHTML), e)
      ...
      return t
        ? ((V.innerHTML = ""),
          G.startDelete
            ? ((V.innerHTML = t),
              i(V),
              F(E({ func: j, delay: M(1), deletable: !0 }, x().length)),
              e)
            : t
                .replace(/<!--(.+?)-->/g, "")
                .trim()
      ...
      G.strings.length &&
        (() => {
          ...
          e.forEach((t, n) => {
            ...
            let r = G.breakLines
              ? [{ func: () => z(d("BR")), typeable: !0 }]
              : E({ func: j, delay: M(1) }, Y.getTypeable().length);
            F(r);
          });
        })();
  };
